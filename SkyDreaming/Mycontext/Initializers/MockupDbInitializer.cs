...
namespace SkyDreaming.Mycontext.Initializers
{
    public class MockupDbInitializer : DropCreateDatabaseAlways<ApplicationContext>
    {
        protected override void Seed(ApplicationContext context)
        {
            ...
            product r1 = new product() { Id = 1, Name = "Sturm face cream", Cost = 1000, UrlImage = "https://cdn11.bigcommerce.com/s-dwdwr5marw/images/stencil/960w/products/531/578/Face-Cream-1__08337.1592835694.386.513.jpg_c_1&_ga_2.33918375.722347298.1594023925-2071108408__41938.1594392042.jpg?c=1" };
            product r2 = new product() { Id = 2, Name = "Sturm night cream", Cost = 750, UrlImage = "https://cdn11.bigcommerce.com/s-dwdwr5marw/images/stencil/960w/products/2996/5377/GOOD-NIGHT-1__50175.1642752423.jpg?c=1" };
            product r3 = new product() { Id = 3, Name = "Hotel Gorilla's Nest", Cost = 800, UrlImage = "https://i.pinimg.com/originals/4f/b6/77/4fb677d43727f194e6bb0db98e3b9be0.jpg" };
            product r4 = new product() { Id = 4, Name = "Hotel Sunshine", Cost = 1200, UrlImage = "https://static.propertylogic.net/blog/1448297869/internationl_luxury_premium_bedproduct.jpg" };
            product r5 = new product() { Id = 5, Name = "Hotel The Bachelor", Cost = 1069, UrlImage = "http://cdn.home-designing.com/wp-content/uploads/2014/09/bachelor-bedproduct.jpeg" };
            product r6 = new product() { Id = 6, Name = "Saunt laurent Dress", Cost = 1050, UrlImage = "https://saint-laurent.dam.kering.com/m/7ac568fa83ad455d/Medium2-693962Y36UR1000_A.jpg?v=2" };
            product r7 = new product() { Id = 7, Name = "Volvo car", Cost = 600, UrlImage = "https://carwow-uk-wp-3.imgix.net/Volvo-XC40-white-scaled.jpg" };
            product r8 = new product() { Id = 8, Name = "Wedding Dress", Cost = 1750, UrlImage = "https://cdn.shopify.com/s/files/1/0584/8983/1574/products/GRACELOVESLACE.SHOP.WEDDING-DRESSES.MILA-01_1024x.jpg?v=1651479474" };
            product r9 = new product() { Id = 9, Name = "Dress Shoes", Cost = 900, UrlImage = "https://media.jimmychoo.com/image/upload/f_auto,q_auto:best,dpr_2.0,w_520,h_520,c_fit/ROWPROD_PRODUCT/images/original/ROMY85CGF_120011_SIDE_vg01.jpg" };
            product r10 = new product() { Id = 10, Name = "Iphone 14 pro", Cost = 1050, UrlImage = "https://techblog.gr/wp-content/uploads/2022/09/iphone-14-pro-iphone-14-pro-max-3.jpg" };

            context.products.AddOrUpdate(r => r.Name, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10);
            context.SaveChanges();
